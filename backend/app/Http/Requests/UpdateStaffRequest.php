...
class UpdateStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'initial_command' => 'nullable|integer|exists:states,id',
            'present_command' => 'nullable|integer|exists:states,id',
            ...
            'work_distribution_id' => 'nullable|integer|exists:work_distributions,id',
            'training_institute_id' => 'nullable|integer|exists:training_institutes,id',
            'directorate_id' => 'nullable|integer|exists:directorates,id',
            'staff_status_id' => 'nullable|integer|exists:statuses,id',
