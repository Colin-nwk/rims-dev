...
class UpdateStaffDocumentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'document_type' => ['sometimes', 'string', 'in:birth_certificate,confirmation_certificate,national_id,passport,appointment_letter,promotion_letter,transfer_letter,other'],
