    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-indigo-950 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-20">
                <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-gold-700 blur-3xl"></div>
                <div className="absolute top-1/2 -left-24 w-72 h-72 rounded-full bg-navy-800 blur-3xl"></div>
            </div>
            ...
            <Card className="w-full max-w-md relative z-10 backdrop-blur-md bg-white/95 dark:bg-navy-900/90 border-white/20 p-8 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <Button
                        type="submit"
                        className="w-full text-base shadow-lg shadow-navy-900/20 bg-indigo-900 hover:bg-indigo-800 text-white"
                        isLoading={isPending}
                        disabled={isPending}
                    >
                        Sign In
