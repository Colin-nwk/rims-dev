    ...
    <Modal isOpen={Boolean(serviceNo)} onClose={onClose} title="Staff report detail" description={serviceNo} size="full">
      ...
      {staff ? <div className="space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <DetailSection icon={MapPin} title="Organization & location" values={{ Directorate: staff.organization.directorate, Department: staff.organization.department, "Work distribution": staff.organization.work_distribution, "Custodial centre": staff.location.prison, Station: staff.location.station }} />
